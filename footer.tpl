        ...
        <div class="row">
            ...
            <div class="col-sm-5 mb-0">
                <div class="float-right">
                    ...
                    <a class="ml-1" href="https://namelessmc.com" target="_blank" data-toggle="tooltip" data-placement="top" title="Website"><i class="far fa-globe fa-fw text-primary"></i></a>
                    <a class="ml-1" href="https://namelessmc.com/donate/" target="_blank" data-toggle="tooltip" data-placement="top" title="Donate"><i class="far fa-heart fa-fw text-danger"></i></a>
                </div>
            </div>
        </div>
    </div>

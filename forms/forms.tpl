            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        ...
                        <span class="float-end"><a href="{$NEW_FORM_LINK}" class="btn btn-primary">{$NEW_FORM}</a></span>
                        <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <span class="float-end"><b>{$ACTION}</b></span>
                            </div>
                        </div>
                        {if count($FORMS_LIST)}
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <span class="float-end"><a href="{$NEW_STATUS_LINK}" class="btn btn-primary">{$NEW_STATUS}</a></span>
                        <hr>

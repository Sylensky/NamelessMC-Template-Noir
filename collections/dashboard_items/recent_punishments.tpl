<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <div id="APunishment">
            ...
            <div class="card mb-1 c-pointer" id="HPunishment{$i}}" data-bs-toggle="collapse" data-bs-target="#CPunishment{$i}" aria-expanded="true" aria-controls="CPunishment{$i}">
                <div class="card-header ama">
                    ...
                    <div class="collapse" id="CPunishment{$i}" aria-labelledby="HPunishment{$i}" data-bs-parent="#APunishment">
                        <hr>
                        <b>{$CREATED}</b> <span data-bs-toggle="tooltip" title="{$punishment.time_full}">{$punishment.time}</span><br>

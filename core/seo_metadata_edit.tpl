            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">{$PAGE_METADATA}</h4>
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{$PANEL_INDEX}">{$DASHBOARD}</a></li>
                                    <li class="breadcrumb-item">{$CONFIGURATION}</li>
                                    <li class="breadcrumb-item">{$SEO}</li>
                                    <li class="breadcrumb-item">{$PAGE_METADATA}</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <form action="" method="post">
                        ...
                        <div class="card-header">{$EDITING_PAGE}</div>
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{$BACK_LINK}" class="btn btn-outline-primary btn-sm float-right">{$BACK}</a>
                        </div>
                    </form>
                </div>
            </div>
